...
pub (crate) mod reachable_hashes;
mod trie_collection;
mod map_with_counter;

pub use trie_collection::{DatabaseTrieMut, RootGuard, TrieCollection};
pub use map_with_counter::MapWithCounterCached;
...
pub mod tests {
    ...
    use super::*;
    use super::map_with_counter::MapWithCounter;
